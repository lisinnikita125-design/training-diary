...
def ai_analyze():
    ...
    prompt = (
        ...
        recovery + "\n\n"
        "ПРАВИЛА ОТВЕТА:\n"
        "1. ПЕРСОНАЛИЗАЦИЯ ОБЯЗАТЕЛЬНА: в блоке 'Оценка прошедшей тренировки' первым предложением напиши профиль пользователя и вывод — например: 'Для мужчины 31 года с массой 78 кг: тоннаж вырос, темп прогрессии безопасен.' Если профиль не заполнен — пропусти.\n"
