...
def ai_analyze():
    ...
    prompt = (
        ...
        recovery + "\n\n"
        "ПРАВИЛА ОТВЕТА:\n"
        "1. ПЕРСОНАЛИЗАЦИЯ ОБЯЗАТЕЛЬНА: в блоке 'Оценка прошедшей тренировки' первым предложением ОБЯЗАТЕЛЬНО напиши вывод с использованием возраста, пола и массы тела из блока ПРОФИЛЬ ПОЛЬЗОВАТЕЛЯ. Пример: 'Для мужчины 32 лет, 72 кг: тоннаж вырос на X кг, темп прогрессии соответствует возрасту.' Если профиль не заполнен — пропусти.\n"
